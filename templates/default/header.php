...
if (!$fullscreen) {
    ...
    <head>
        ...
        <style>
            /* Override WordPress layout constraints for fullscreen mode */
            .eddcdp-fullscreen-mode * {
                max-width: none !important;
                margin-left: 0 !important;
                margin-right: 0 !important;
            }
            
            .eddcdp-fullscreen-mode .is-layout-constrained > :where(:not(.alignleft):not(.alignright):not(.alignfull)) {
                max-width: none !important;
                margin-left: 0 !important;
                margin-right: 0 !important;
            }
