...
<div class="bg-white/80 backdrop-blur-xl rounded-2xl p-6 mb-6 shadow-lg border border-white/20">
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <span class="<?php echo esc_attr($status_class); ?> px-4 py-2 rounded-full text-sm font-medium w-fit">
            <?php echo esc_html($status_icon . ' ' . ucfirst($order->status)); ?>
        </span>
    </div>
</div>
...
<!-- Order Items -->
<div class="bg-white/80 backdrop-blur-xl rounded-2xl p-6 mb-6 shadow-lg border border-white/20">
    <h3 class="text-xl font-semibold text-gray-800 mb-4"><?php esc_html_e('Items Purchased', 'edd-customer-dashboard-pro'); ?></h3>
    ...
    <div class="space-y-4">
        ...
        <div class="border border-gray-200 rounded-xl p-4">
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                <div class="flex-1">
                    ...
                    <p class="text-gray-600 mt-1">
                        ...
                        printf(esc_html__('Quantity: %1$d × %2$s', 'edd-customer-dashboard-pro'), esc_html(number_format_i18n($item->quantity)), esc_html(edd_currency_filter(edd_format_amount($item->amount)))); 
                        ?>
                    </p>
                    ...
                    <div class="mt-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
                        <h6 class="text-sm font-semibold text-blue-900 mb-3 flex items-center gap-2">
                            🔑 <?php esc_html_e('License Keys', 'edd-customer-dashboard-pro'); ?>
                        </h6>
                            ...
                            <div class="bg-white rounded-lg p-3 border border-blue-200">
                                ...
                                <div class="flex items-center gap-3 mb-2">
                                    ...
                                    <button onclick="copyLicenseKey(this, '<?php echo esc_js($license->license_key); ?>')" 
                                        ...
                                        📋 <span class="copy-text"><?php esc_html_e('Copy', 'edd-customer-dashboard-pro'); ?></span>
                                    </button>
                                </div>
                                ...
                                <div class="flex flex-wrap gap-4 text-xs text-blue-700">
                                    <span class="flex items-center gap-1">
                                        ...
                                        printf(esc_html__('Status: %s', 'edd-customer-dashboard-pro'), esc_html(ucfirst($license->status))); 
                                        ?>
                                    </span>
                                    ...
                                    <span class="flex items-center gap-1">
                                        ...
                                        printf(esc_html__('Expires: %s', 'edd-customer-dashboard-pro'), esc_html(date_i18n(get_option('date_format'), strtotime($license->expiration)))); 
                                        ?>
                                    </span>
                                    <?php endif; ?>
                                    ...
                                    <span class="flex items-center gap-1">
                                        🌐 <?php 
                                        $limit_display = $license->activation_limit ?: esc_html__('∞', 'edd-customer-dashboard-pro');
                                        /* translators: %1$d: Current activations, %2$s: Activation limit (number or ∞) */
                                        printf(esc_html__('Sites: %1$d/%2$s', 'edd-customer-dashboard-pro'), esc_html(number_format_i18n($license->activation_count)), esc_html($limit_display)); 
                                        ?>
                                    </span>
                                </div>
                            </div>
            ...
            <div class="mt-4 pt-4 border-t border-gray-200">
                <h5 class="font-medium text-gray-700 mb-3">📥 <?php esc_html_e('Download Files:', 'edd-customer-dashboard-pro'); ?></h5>
            ...
            <div class="mt-4 pt-4 border-t border-gray-200">
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                    <p class="text-yellow-800 text-sm">
                        ⏳ <?php esc_html_e('Downloads will be available once your order is complete.', 'edd-customer-dashboard-pro'); ?>
                    </p>
                </div>
            </div>
            <?php endif; ?>
...
<!-- Order Summary -->
<div class="bg-white/80 backdrop-blur-xl rounded-2xl p-6 mb-6 shadow-lg border border-white/20">
    <h3 class="text-xl font-semibold text-gray-800 mb-4"><?php esc_html_e('Order Summary', 'edd-customer-dashboard-pro'); ?></h3>
    
    <div class="space-y-3">
        <div class="flex justify-between items-center">
            <span class="text-gray-600"><?php esc_html_e('Subtotal:', 'edd-customer-dashboard-pro'); ?></span>
            <span class="font-medium"><?php echo esc_html(edd_currency_filter(edd_format_amount($order->subtotal))); ?></span>
        </div>
        
        <?php if ($order->tax > 0) : ?>
        <div class="flex justify-between items-center">
            <span class="text-gray-600"><?php esc_html_e('Tax:', 'edd-customer-dashboard-pro'); ?></span>
            <span class="font-medium"><?php echo esc_html(edd_currency_filter(edd_format_amount($order->tax))); ?></span>
        </div>
        <?php endif; ?>
        
        <?php if ($order->discount_amount > 0) : ?>
        <div class="flex justify-between items-center">
            <span class="text-gray-600"><?php esc_html_e('Discount:', 'edd-customer-dashboard-pro'); ?></span>
            <span class="font-medium text-green-600">-<?php echo esc_html(edd_currency_filter(edd_format_amount($order->discount_amount))); ?></span>
        </div>
        <?php endif; ?>
        
        <div class="border-t border-gray-200 pt-3">
            <div class="flex justify-between items-center">
                <span class="text-lg font-semibold text-gray-800"><?php esc_html_e('Total:', 'edd-customer-dashboard-pro'); ?></span>
                <span class="text-lg font-bold text-gray-800"><?php echo esc_html(edd_currency_filter(edd_format_amount($order->total))); ?></span>
            </div>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-2xl p-6 shadow-lg border border-white/20">
        <h3 class="text-xl font-semibold text-gray-800 mb-4"><?php esc_html_e('Payment Information', 'edd-customer-dashboard-pro'); ?></h3>
        
        <div class="space-y-3">
            <div>
                <span class="text-gray-600"><?php esc_html_e('Payment Method:', 'edd-customer-dashboard-pro'); ?></span>
            ...
            <div>
                <span class="text-gray-600"><?php esc_html_e('Email:', 'edd-customer-dashboard-pro'); ?></span>
                <div class="font-medium"><?php echo esc_html($order->email); ?></div>
            </div>
            
            <?php if (!empty($order->transaction_id)) : ?>
            <div>
                <span class="text-gray-600"><?php esc_html_e('Transaction ID:', 'edd-customer-dashboard-pro'); ?></span>
    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-2xl p-6 shadow-lg border border-white/20">
        <h3 class="text-xl font-semibold text-gray-800 mb-4"><?php esc_html_e('Billing Address', 'edd-customer-dashboard-pro'); ?></h3>
...
function showCopySuccess(element) {
    ...
    if (copyText) {
        ...
        copyText.textContent = '<?php esc_js_e('Copied!', 'edd-customer-dashboard-pro'); ?>';
...
function showCopyError(element) {
    ...
    if (copyText) {
        const originalText = copyText.textContent;
        copyText.textContent = '<?php esc_js_e('Failed', 'edd-customer-dashboard-pro'); ?>';
