<?php
/**
 * Support Section Template - Fixed output escaping
 */
...
<div class="eddcdp-support-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px; margin-bottom: 30px;">
    <div class="eddcdp-support-card" style="background: rgba(248, 250, 252, 0.8); border-radius: 12px; padding: 25px; text-align: center;">
        ...
        <p><?php esc_html_e('Get help with your purchases, downloads, or technical issues.', 'edd-customer-dashboard-pro'); ?></p>
    ...
    <div class="eddcdp-support-card" style="background: rgba(248, 250, 252, 0.8); border-radius: 12px; padding: 25px; text-align: center;">
        ...
        <p><?php esc_html_e('Chat with our support team in real-time.', 'edd-customer-dashboard-pro'); ?></p>
        <button class="eddcdp-btn" style="margin-top: 15px;" onclick="alert('<?php esc_html_e('Live chat integration coming soon!', 'edd-customer-dashboard-pro'); ?>');">
...
<div class="eddcdp-faq-section">
    <h3><?php esc_html_e('Frequently Asked Questions', 'edd-customer-dashboard-pro'); ?></h3>
    ...
    <div class="eddcdp-faq-list" style="margin-top: 20px;">
        <div class="eddcdp-faq-item" style="background: rgba(248, 250, 252, 0.8); border-radius: 8px; margin-bottom: 15px; overflow: hidden;">
            <div class="eddcdp-faq-question" style="padding: 15px; cursor: pointer; font-weight: 600; color: #333; border-bottom: 1px solid rgba(0,0,0,0.1);" onclick="this.nextElementSibling.style.display = this.nextElementSibling.style.display === 'none' ? 'block' : 'none';">
                <?php esc_html_e('How do I update my account information?', 'edd-customer-dashboard-pro'); ?>
        ...
        <div class="eddcdp-faq-item" style="background: rgba(248, 250, 252, 0.8); border-radius: 8px; margin-bottom: 15px; overflow: hidden;">
            <div class="eddcdp-faq-question" style="padding: 15px; cursor: pointer; font-weight: 600; color: #333; border-bottom: 1px solid rgba(0,0,0,0.1);" onclick="this.nextElementSibling.style.display = this.nextElementSibling.style.display === 'none' ? 'block' : 'none';">
                <?php esc_html_e('How do I manage my software licenses?', 'edd-customer-dashboard-pro'); ?>
                <span style="float: right;">▼</span>
            </div>
            <div class="eddcdp-faq-answer" style="padding: 15px; display: none; color: #666;">
        ...
        <div class="eddcdp-faq-item" style="background: rgba(248, 250, 252, 0.8); border-radius: 8px; margin-bottom: 15px; overflow: hidden;">
            <div class="eddcdp-faq-question" style="padding: 15px; cursor: pointer; font-weight: 600; color: #333; border-bottom: 1px solid rgba(0,0,0,0.1);" onclick="this.nextElementSibling.style.display = this.nextElementSibling.style.display === 'none' ? 'block' : 'none';">
                <?php esc_html_e('Can I re-download my files?', 'edd-customer-dashboard-pro'); ?>
                <span style="float: right;">▼</span>
            </div>
            <div class="eddcdp-faq-answer" style="padding: 15px; display: none; color: #666;">
        ...
        <div class="eddcdp-faq-item" style="background: rgba(248, 250, 252, 0.8); border-radius: 8px; margin-bottom: 15px; overflow: hidden;">
            <div class="eddcdp-faq-question" style="padding: 15px; cursor: pointer; font-weight: 600; color: #333; border-bottom: 1px solid rgba(0,0,0,0.1);" onclick="this.nextElementSibling.style.display = this.nextElementSibling.style.display === 'none' ? 'block' : 'none';">
                <?php esc_html_e('How do I download my purchased files?', 'edd-customer-dashboard-pro'); ?>
                <span style="float: right;">▼</span>
            </div>
            <div class="eddcdp-faq-answer" style="padding: 15px; display: none; color: #666;">
