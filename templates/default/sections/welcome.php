    ...
    <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
        <div class="text-center lg:text-left">
            <h1 class="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-3">
                <?php printf(__('Welcome back, %s! 👋', 'edd-customer-dashboard-pro'), $current_user->display_name); ?>
            </h1>
            <p class="text-gray-600 text-lg"><?php _e('Manage your digital products, licenses, and downloads', 'edd-customer-dashboard-pro'); ?></p>
        </div>
